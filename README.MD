...
**Note**: [Claude](https://claude.ai/) and (Bard)(Https://bard.google.com/] presents two authentication options - logging in through your browser or follow the instructions below to configure.
