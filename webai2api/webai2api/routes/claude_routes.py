...
@router.post("/claude")
async def ask_claude(message: dict):
    ...
    if not COOKIE_CLAUDE:
        ...
        return {
            "warning": "Looks like you're not logged in to Claude. Please either set the Claude cookie manually or "
                       "log in to your Claude.ai account through your web browser."}
...
# @router.post("/claude") async def ask_claude(request: Request, message: dict): logging.info(
# "claude_routes.py./claude") if not COOKIE_CLAUDE: yield {"warning": "Looks like you're not logged in to Claude.
# Please either set the Claude cookie manually or log in to your Claude.ai account through your web browser."} return
