...
from ..utils.utility import getCookie_Claude, claudeToChatGPTStream, getCookie_Gemini, geminiToChatGPTStream, ResponseModel, ConvertToChatGPT, CONFIG_FILE_NAME, CONFIG_FILE_PATH, ConfigINI_to_Dict
...
def initialize_cookies():
    ...
    COOKIE_GEMINI = getCookie_Gemini(configfilepath=os.getcwd(), configfilename=CONFIG_FILE_NAME)
    CLAUDE_CLIENT = Client(COOKIE_CLAUDE)
    GEMINI_CLIENT = GeminiClient()

initialize_cookies()

async def web_ui_middleware(request: Request, response: ResponseModel, url: str):
